...
export function CalculatorForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      // Set target weight change based on goal
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto shadow-lg border-primary/20">
      <CardHeader className="space-y-2">
        <CardTitle className="text-2xl font-bold text-primary">Hola, {userName}! 👋</CardTitle>
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.goal} onValueChange={(value) => setFormData({ ...formData, goal: value as any })}>
